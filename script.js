...
const timelineData = [
  {
    date: "30 декабря",
    img: "img/1.png",
    text: "Интересное знакомство. То самое сообщение, с которого всё началось",
  },
  {
    date: "2 января",
    img: "img/2.png",
    text: "Первая встреча. Прогулка, кино - и реальность оказалась даже лучше, чем в переписке",
  },
  {
    date: "7 января",
    img: "img/3.png",
    text: "Рождество. Первый подарок - маленький, но такой значимый",
  },
  {
    date: "8 января",
    img: "img/4.png",
    text: "Впервые проводил тебя до дома. Так не хотелось, чтобы вечер заканчивался…",
  },
  {
    date: "10 января",
    img: "img/5.png",
    text: "Первый кружок от тебя. Поймал себя на том, что пересматриваю его снова и снова",
  },
  {
    date: "22 января",
    img: "img/6.png",
    text: "Первый совместный просмотр фильма у меня дома",
  },
  {
    date: "28 января",
    img: "img/7.png",
    text: "Первый поцелуй. Точка, после которой всё изменилось",
  },
  {
    date: "14 февраля",
    img: "img/8.png",
    text: "Мой первый интерактивный подарок для тебя",
  },
];
